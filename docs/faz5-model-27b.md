...
| Qwen3.6-27B-IQ4_XS × cli × uzun | 4 | 100% [51%–100%] | 100% | — | 0 | 0 | 0 (4) | 0 | 7 | 0.65 | 0.80 |
| Qwen3.6-27B-IQ4_XS × cli × geçmiş(izli) | 10 | 90% [60%–98%] | 100% | — | 0 | 0 | 0 (3) | 0 | 17 | 0.53 | 0.91 |
| Qwen3.6-27B-IQ4_XS × cli × geçmiş(izsiz) | 10 | 90% [60%–98%] | 100% | — | 0 | 0 | 0 (3) | 0 | 17 | 0.50 | 0.88 |
| Qwen3.6-27B-IQ4_XS × json | 50 | 88% [76%–94%] | 91% | — | 0 | 0 | 2 (5) | 1 | 29 | 0.18 | 0.82 |
| Qwen3.6-27B-IQ4_XS × json × kontrol | 18 | 94% [74%–99%] | — | — | 0 | 0 | 0 (0) | 0 | 78 | 0.13 | 1.81 |
...
| Qwen3.6-27B-IQ4_XS × json × uzun | 3 | 100% [44%–100%] | 100% | — | 0 | 0 | 0 (3) | 0 | 17 | 0.59 | 0.96 |
| Qwen3.6-27B-IQ4_XS × json × geçmiş(izli) | 10 | 90% [60%–98%] | 100% | — | 0 | 0 | 0 (3) | 0 | 27 | 0.43 | 1.02 |
...
| Qwen3.6-27B-IQ4_XS × json × uzun | 100% (3) | — | — |
...
**Qwen3.6-27B-IQ4_XS × json × uzun** — 1/4:

- `uzn-04`: Qwen3.6-27B-IQ4_XS: akış kesildi: 
...
- `tek-05`: `22.6`, `29.4` — yanıt: `Bilgisayarın bellek durumu şu şekilde:
